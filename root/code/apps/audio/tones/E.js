//Trying to figure out how to make vowels with "formant" frequencies
/*
[300, 870, 2240],
[390, 1990, 2550],
[270, 2290, 3010],
...
const init=()=>{//«
let vowels = [
[570, 640, 2410],//0  bought
[300, 870, 2240],//1  boot
[440, 1020, 2240],//2  foot
[730, 1090, 2440],//3 hot
[520, 1190, 2390],//4 but
[490, 1350, 1690],//5  bird
[660, 1720, 2410],//6  bat
[530, 1840, 2480],//7  bet
[390, 1990, 2550],//8 bit
[270, 2290, 3010],//9 beet
];

let VOWEL_NUM=7;

let vow = vowels[VOWEL_NUM];
//log(vow);
let usemult = 4;

let o1 = sqr(vow[0]/usemult);
let o2 = sqr(vow[1]/usemult);
let o3 = sqr(vow[2]/usemult);
let g1=gn(0.33);
let g2=gn(0.166);
let g3=gn(0.083);
o1.connect(g1);
